        ...
        child:  Column(
          ...
          children: [
            ...
            Expanded(child: Padding(
              ...
              child: Obx(() => _homeController.isLoading.value?ListView.builder(
                itemCount: 5,
                ...
                child: Column(
                  ...
                  //     "zipCode": "ru236022"
                 children: [
                   Text(_homeController.accountInfo.value.address.toString()),
                   Text(_homeController.accountInfo.value.balance.toString()),
                   Text(_homeController.accountInfo.value.city.toString()),
                   Text(_homeController.accountInfo.value.country.toString()),
        ...
        children: [
          ...
          Expanded(
            child: RefreshIndicator(
              ...
              child: Obx(
                    () =>_homeController.isLoading.value?ListView.builder(
                      itemCount: 5,
                      itemBuilder: (BuildContext context, int index) {
                        return Shimmer.fromColors(
                            baseColor: Colors.grey[300]!,
